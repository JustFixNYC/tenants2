...
export const IssueChoices: IssueChoice[] = [
  ...
  "PUBLIC_AREAS__COVID_19_SANITATION_REQUIRED",
...
export function getIssueChoiceLabels(): IssueChoiceLabels {
  return {
    HOME__COVID_19_SANITATION_REQUIRED: "COVID-19 Sanitation Required",
    HOME__MICE: "Mice",
    HOME__RATS: "Rats",
    ...
    PUBLIC_AREAS__COVID_19_SANITATION_REQUIRED: "COVID-19 Sanitation Required",
