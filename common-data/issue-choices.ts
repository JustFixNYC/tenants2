...
export function getIssueChoiceLabels(): IssueChoiceLabels {
  return {
    ...
    HOME__PAINTING: "Apartment Needs Painting",
    ...
    HOME__LEAD_BASED_PAINT: "Lead-based Paint",
    HOME__VACATE_ORDER_ISSUED: "Vacate Order Issued",
    ...
    BATHROOMS__SINK_WATER_PRESSURE: "Sink: Low Water pressure",
    ...
    PUBLIC_AREAS__ELECTRICAL_CURRENT: "Weak electrical current",
    PUBLIC_AREAS__BUGS: "Bug Infestation",
    PUBLIC_AREAS__PESTS: "Rats/Mice",
    PUBLIC_AREAS__FUMES: "Fumes/smoke entering apartment",
    PUBLIC_AREAS__SMOKE_DETECTORS: "Broken/no smoke/Co2 detector",
    ...
    PUBLIC_AREAS__INCOMPLETE_RENT_RECEIPTS: "Rent receipts incomplete",
  };
}
