...
export const CovidEhpDisclaimer = () => {
  ...
  return (
    <div className="jf-covid-ehp-disclaimer notification is-warning">
      <p>Due to the covid-19 pandemic, Housing Courts in New York City are only accepting cases for the following conditions, or others that threaten the health and safety of your household:</p>
