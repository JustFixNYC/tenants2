              ...
              <div className="columns is-centered">
                <div className="column is-four-fifths is-size-3 is-size-4-mobile has-text-centered-tablet">
                  <Trans id="evictionfree.introToLaw2">
                    New York State law temporarily protects tenants from
                    eviction due to lost income or COVID-19 health risks. In
                    order to get protected, you must fill out a hardship
                    declaration form and send it to your landlord and/or the
                    courts. Because of landlord attacks, these laws have been
                    weakened.{" "}
                ...
                <div className="hero-body">
                  ...
                  <p>
                    <Trans id="evictionfree.whoHasRightToSubmitForm">
                      All tenants in New York State have a right to fill out
                      this hardship declaration form. Especially if you've been
                      served an eviction notice or believe you are at risk of
                      being evicted, please consider using this form to protect
                      yourself.
                    </Trans>
                  </p>
                  <br />
                ...
                <div className="column is-three-quarters has-text-centered-tablet">
                  ...
                  <p className="is-size-3 is-size-4-mobile has-text-white">
                    <Trans>
                      ...
                      local organizing groups to get involved in the fight to
                      make New York eviction free!
                    </Trans>
                  </p>
                  <br />
