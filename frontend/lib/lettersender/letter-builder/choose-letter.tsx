...
import { LetterSenderCreateLetterMutation } from "../../queries/LetterSenderCreateLetterMutation";
...
export const LaLetterBuilderChooseLetterStep: React.FC<ProgressStepProps> = (
  ...
  return (
    <Page title={li18n._(t`Select a letter to get started`)}>
      <section className="jf-lettersender-section-primary">
...
export const StartLetterButton: React.FC<{ className?: string }> = ({
  ...
  return (
    <SessionUpdatingFormSubmitter
      mutation={LetterSenderCreateLetterMutation}
      initialState={{}}
      onSuccessRedirect={
