...
export const NorentHomepage: React.FC<{}> = () => (
  <Page title="NoRent.org" className="content">
    ...
    <section className="container">
      <div className="hero is-small is-paddingless">
          ...
          <article className="message">
            <div className="message-body has-background-grey-lighter has-text-left">
              ...
              <p>
                ...
                related to the pandemic. Until further notice, I will be unable
                to pay my rent due to the COVID-19 emergency.
              </p>
              <br />
              <p>
              ...
              <br />
              <p>
                Tenants in covered properties are also protected from eviction,
                fees, penalties, and other charges related to non-payment by the
                CARES Act (Title IV, Sec. 4024) enacted by Congress on March 27,
                2020.
              </p>
              <br />
              <p>
