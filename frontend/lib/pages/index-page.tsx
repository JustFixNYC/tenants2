  ...
  renderLoggedOut() {
    return (
      <Page className="landing-page" title="Technology for Housing Justice">
        ...
        <section className="hero is-light">
          <div className="hero-body">
            <div className="has-text-centered">
              ...
              <div className="jf-loc-image">{locSvg}</div>
        ...
        <section className="section">
          <div className="content">
            <h1 className="has-text-centered">What are the benefits of mailing a Certified Letter of Complaint?</h1>
            <p>
        ...
        <section className="section">
          <div className="content">
            <h1 className="has-text-centered">About JustFix.nyc</h1>
            <p>
