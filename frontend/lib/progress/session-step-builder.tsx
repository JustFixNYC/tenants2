...
import { SessionUpdatingFormOutput, SessionUpdatingFormSubmitter } from "../forms/session-updating-form-submitter";
 ...
 * user's session.
 */
export type SessionStepOptions<FormInput, FormOutput extends SessionUpdatingFormOutput, SessionChunk> = {
...
export class SessionStepBuilder<SessionChunk> {
  constructor(readonly fromSession: (session: AllSessionInfo) => SessionChunk|null) {
  }
  ...
  createStep<FormInput, FormOutput extends SessionUpdatingFormOutput>(
    options: SessionStepOptions<FormInput, FormOutput, SessionChunk>|
             ((props: MiddleProgressStepProps) => SessionStepOptions<FormInput, FormOutput, SessionChunk>)
  ) {
