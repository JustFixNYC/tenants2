...
describe('LoginForm', () => {
  it('submits field values', () => {
    ...
    const form = mount(<LoginForm onSubmit={mockSubmit} isLoading={false} />);
  ...
  it('renders field and non-field errors', () => {
    ...
    const form = mount(<LoginForm onSubmit={jest.fn()} errors={errors} isLoading={false} />);
  ...
  it('does not trigger submissions when already loading', () => {
    const mockSubmit = jest.fn();
    const form = mount(<LoginForm onSubmit={mockSubmit} isLoading={true} />);
    form.simulate('submit');
