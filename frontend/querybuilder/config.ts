 ...
 */
export const AUTOGEN_CONFIG_PATH = path.join(
  QUERIES_PATH,
  "autogen-config.toml"
);

/** The preamble at the top of GraphQL files we automatically generate. */
export const AUTOGEN_PREAMBLE = `# This file was auto-generated by querybuilder, please do not edit it.\n`;
...
const WATCHABLE_QUERY_PATHS = [QUERIES_PATH];

/** The directories containing all our GraphQL queries. */
const ALL_QUERY_PATHS = [...WATCHABLE_QUERY_PATHS, AUTOGEN_QUERIES_PATH];
 ...
 */
export const COPY_FROM_APOLLO_GEN_TO_QUERIES = ["globalTypes.ts"];
