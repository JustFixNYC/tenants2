# Generated by Django 3.2.13 on 2025-11-06 17:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.TextField(blank=True, choices=[('PLANNED_INCREASE', 'Landlord plans to increase the rent above the reasonable standard.'), ('NON_RENEWAL', 'Landlord plans to not offer a lease renewal.')], help_text='Selected reason for sending the letter (e.g. lease non-renewal, rent increase)', max_length=30, null=True)),
                ('good_cause_given', models.BooleanField(blank=True, help_text="Whether the landlord initially provided a 'good cause' justification for not offering a lease renewal", null=True)),
                ('cc_user', models.BooleanField(blank=True, help_text="Whether the user should be cc'd on the email to the landlord", null=True)),
                ('extra_emails', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(blank=True, max_length=254, null=True), blank=True, help_text='List of additional emails to send a copy of the letter.', null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text="The user's email address.", max_length=254, null=True)),
                ...
                ('secondary_line', models.CharField(blank=True, help_text='Optional. Usually the second line of the address, e.g. "Suite 2"', max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text="The landlord's email address.", max_length=254, null=True)),
