...
from loc.views import (
    can_we_render_pdfs,
    render_document,
    normalize_prerendered_loc_html,
    react_render_loc_html,
...
ignore_defusedxml_warning = pytest.mark.filterwarnings("ignore:The html argument of XMLParser")
...
def requires_pdf_rendering(fn):
    @pytest.mark.skipif(not can_we_render_pdfs(), reason="PDF generation is unsupported")
