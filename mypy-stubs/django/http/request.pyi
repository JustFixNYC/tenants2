...
UploadHandlerList = Union[
    List[uploadhandler.FileUploadHandler], ImmutableList[uploadhandler.FileUploadHandler]
]
...
class HttpRequest:
    ...
    def get_signed_cookie(
        self, key: str, default: str = ..., salt: str = "", max_age: int = None
    ) -> str: ...
...
class QueryDict(MultiValueDict[str, str]):
    ...
    def __init__(
        self,
        query_string: Union[str, bytes, None] = None,
        mutable: bool = False,
