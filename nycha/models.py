...
class NychaOffice(MailingAddress):
    name = models.CharField(max_length=255, help_text="The name of the management entity.")
...
class NychaProperty(models.Model):
    ...
    address = models.CharField(
        max_length=100, help_text="The street address of the NYCHA property."
    )

    development = models.CharField(
        max_length=255, help_text="The development name of the NYCHA property."
    )
