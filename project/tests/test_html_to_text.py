...
def test_it_adds_anchor_hrefs():
    assert html_to_text('<p><a href="https://boop">visit it</a></p>') == ("visit it: https://boop")
...
def test_it_supports_unordered_lists():
    assert html_to_text("<ul><li>boop</li><li>bap</li></ul>") == ("* boop\n\n" "* bap")
...
def test_it_supports_nested_ordered_lists():
    assert html_to_text(
        "<ol>" '<li>boop<ol type="a"><li>hi</li><li>bye</li></ol></li>' "<li>bap</li>" "</ol>"
    ) == ("1. boop\n\n" "a. hi\n\n" "b. bye\n\n" "2. bap")


def test_it_supports_nested_mixed_lists():
    assert html_to_text("<ol>" "<li>boop<ul><li>oof</li></ul></li>" "<li>bap</li>" "</ol>") == (
        "1. boop\n\n" "* oof\n\n" "2. bap"
    )
