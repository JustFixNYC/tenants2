...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("full_preferred_name")
    ...
    def handle(self, *args, **options):
        ...
        full_preferred_name: str = options["full_preferred_name"]
        ...
        print(
            f"Adding {full_preferred_name} ({phone_number}, {locale}) to "
            f"{campaign_name} follow-up campaign..."
        )
        campaign.add_contact(client, full_preferred_name, phone_number, locale)
        print("Done.")
